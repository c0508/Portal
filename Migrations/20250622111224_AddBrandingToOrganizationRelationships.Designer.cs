...
namespace ESGPlatform.Migrations
{
    ...
    [Migration("20250622111224_AddBrandingToOrganizationRelationships")]
    partial class AddBrandingToOrganizationRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ESGPlatform.Models.Entities.Question", b =>
                {
                    ...
                    b.HasOne("ESGPlatform.Models.Entities.QuestionnaireVersion", null)
                        .WithMany("Questions")
                        .HasForeignKey("QuestionnaireVersionId");
